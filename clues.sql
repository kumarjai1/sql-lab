...
select country, region, population from country where region = 'Southern Europe' order by population limit 1;
...
select country from country inner join countrylanguage
on country.code like countrylanguage.countrycode
...
select country from country inner join city on country.code like city.countrycode where city.name = 'Serra';
